...
static int bg_max_net_ipc_log_pages = 16;
module_param(bg_max_net_ipc_log_pages, int, 0644);
MODULE_PARM_DESC(bg_max_net_ipc_log_pages,
		 "Pages for net_log IPC ringbuffer (default 16, was 150). 0 disables net_log.");
...
static int __init net_ipc_log_init(void)
{
	...
	if (!log_ctx && bg_max_net_ipc_log_pages > 0)
		log_ctx = ipc_log_context_create(bg_max_net_ipc_log_pages,
