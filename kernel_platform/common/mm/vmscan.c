...
bool am_app_launch;
static int mem_boost_mode_kswapd = KSWAPD_AGGRESSIVE;
 ...
 */
#define DYNAMIC_SWAPPINESS_DELTA 60
				...
				gfp_t gfp_mask, nodemask_t *nodemask)
{
	...
	struct scan_control sc = {
		...
		.may_unmap = 1,
		.may_swap = 1, /* allow swap in direct reclaim: maximize background app retention */
	};
