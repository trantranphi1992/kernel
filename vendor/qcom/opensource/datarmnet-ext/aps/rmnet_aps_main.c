...
static struct DATARMNET6fd48c33f6 *
DATARMNET3ed11fdc8d(u32 DATARMNETbb588401ec) {
...
static void
DATARMNET1e616c2160(struct DATARMNET6fd48c33f6 *DATARMNETaa568481cf) {
...
static void
DATARMNET7fa3dd63cb(struct DATARMNET6fd48c33f6 *DATARMNETaa568481cf) {
...
static void DATARMNET9ac8a34003(void) {
  ...
  hash_for_each_safe(DATARMNET2ee773c365, DATARMNET5c2fd31d7b,
                     DATARMNET0386f6f82a, DATARMNETaa568481cf, hash_list) {
    hash_del(&DATARMNETaa568481cf->hash_list);
    kfree(DATARMNETaa568481cf);
  }
  DATARMNETfef55eaf9a = (0xd2d + 202 - 0xdf7);
  WRITE_ONCE(rmnet_aps_set_prio, NULL);
  DATARMNET112d724eff("\x61\x70\x73\x3a\x20\x61\x6c\x6c\x20\x66\x6c\x6f\x77\x73"
                      "\x20\x72\x65\x6d\x6f\x76\x65\x64"
                      "\n");
}
...
static void DATARMNETf844db79d9(struct timer_list *DATARMNET6e4292679f) {
  ...
  hash_for_each_safe(DATARMNET2ee773c365, DATARMNET5c2fd31d7b,
    ...
    if (time_before_eq(DATARMNETaa568481cf->expires, DATARMNET02dfdbc38d)) {
      DATARMNETbb588401ec =
          DATARMNETaa568481cf->DATARMNET54338da2ff.DATARMNETbb588401ec;
      DATARMNET112d724eff("\x61\x70\x73\x3a\x20\x66\x6c\x6f\x77\x20\x30\x78\x25"
                          "\x78\x20\x65\x78\x70\x69\x72\x65\x64"
                          "\n",
                          DATARMNETbb588401ec);
      DATARMNET7fa3dd63cb(DATARMNETaa568481cf);
...
static int
DATARMNET82d65f9ca6(struct DATARMNET5d4139d9d7 *DATARMNETddcafd8b91) {
  struct DATARMNET6fd48c33f6 *DATARMNETaa568481cf;
  DATARMNETaa568481cf =
  ...
  if (DATARMNETddcafd8b91->cmd == DATARMNET3412b803e1) {
    if (DATARMNETaa568481cf) {
      DATARMNET7fa3dd63cb(DATARMNETaa568481cf);
      DATARMNET112d724eff(
          "\x61\x70\x73\x3a\x20\x66\x6c\x6f\x77\x20\x30\x78\x25\x78\x20\x72\x65"
          "\x6d\x6f\x76\x65\x64\x2c\x20\x63\x6e\x74\x20\x25\x75"
          "\n",
          DATARMNETddcafd8b91->DATARMNETbb588401ec, DATARMNETfef55eaf9a);
    } else {
      DATARMNET112d724eff(
          "\x61\x70\x73\x3a\x20\x66\x6c\x6f\x77\x20\x30\x78\x25\x78\x20\x61\x6c"
          "\x72\x65\x61\x64\x79\x20\x72\x65\x6d\x6f\x76\x65\x64"
          "\n",
  ...
  if (DATARMNETddcafd8b91->cmd == DATARMNETceae994093 && DATARMNETaa568481cf) {
    DATARMNET112d724eff(
        "\x61\x70\x73\x3a\x20\x66\x6c\x6f\x77\x20\x30\x78\x25\x78\x20\x72\x65"
        "\x6d\x6f\x76\x65\x20\x62\x65\x66\x6f\x72\x65\x20\x61\x64\x64"
        "\n",
        DATARMNETddcafd8b91->DATARMNETbb588401ec);
    DATARMNET7fa3dd63cb(DATARMNETaa568481cf);
  ...
  if (!DATARMNETaa568481cf) {
    ...
    DATARMNETaa568481cf = kzalloc(sizeof(*DATARMNETaa568481cf), GFP_ATOMIC);
    if (!DATARMNETaa568481cf) {
      DATARMNET112d724eff(
    ...
    DATARMNET112d724eff(
        "\x61\x70\x73\x3a\x20\x66\x6c\x6f\x77\x20\x30\x78\x25\x78\x20\x61\x64"
        "\x64\x65\x64\x2c\x20\x63\x6e\x74\x20\x25\x75"
        "\n",
        DATARMNETaa568481cf->DATARMNET54338da2ff.DATARMNETbb588401ec,
        DATARMNETfef55eaf9a);
  } else {
    ...
    DATARMNET112d724eff(
        ...
        "\x64\x61\x74\x65\x64\x2c\x20\x63\x6e\x74\x20\x25\x75"
        "\n",
        DATARMNETaa568481cf->DATARMNET54338da2ff.DATARMNETbb588401ec,
        DATARMNETfef55eaf9a);
  }
...
static int DATARMNET1d51fe00f2(struct genl_info *DATARMNET54338da2ff,
  ...
  DATARMNETd7f97e2e5a = genlmsg_put(
      ...
      &DATARMNETcdba30eca9, (0xd2d + 202 - 0xdf7), DATARMNET15437be67e);
  ...
  return (0xd2d + 202 - 0xdf7);
DATARMNETbf4095f79e:
  DATARMNET112d724eff("\x25\x73",
                      "\x41\x50\x53\x5f\x47\x4e\x4c\x3a\x20\x46\x41\x49\x4c\x45"
                      "\x44\x20\x74\x6f\x20\x73\x65\x6e\x64\x20\x61\x70\x73\x20"
                      "\x61\x64\x64\x20\x66\x6c\x6f\x77\x20\x72\x65\x73\x70"
                      "\n");
  return -EFAULT;
}
static void DATARMNET446f780f19(u32 DATARMNETbb588401ec,
  ...
  if (!DATARMNET7d98961cbe.snd_portid) {
    DATARMNET112d724eff("\x61\x70\x73\x20\x63\x6c\x69\x65\x6e\x74\x20\x6e\x6f"
                        "\x74\x20\x63\x6f\x6e\x6e\x65\x63\x74\x65\x64"
                        "\n");
    return;
  }
  ...
  if (DATARMNET1d51fe00f2(&DATARMNET7d98961cbe, &DATARMNETa13fcf9070,
                          GFP_ATOMIC)) {
    DATARMNET112d724eff("\x61\x70\x73\x20\x63\x6c\x69\x65\x6e\x74\x20\x73\x65"
                        "\x6e\x64\x20\x66\x61\x69\x6c\x65\x64\x2e\x20\x64\x69"
                        "\x73\x61\x62\x6c\x65\x20\x63\x6c\x69\x65\x6e\x74"
                        "\n");
...
static void DATARMNET30dd480cad(struct net_device *DATARMNET413e8dcf7b,
  ...
  if (!READ_ONCE(DATARMNETfef55eaf9a))
    return;
  spin_lock_bh(&DATARMNET33bd4139f4);
  DATARMNETaa568481cf = DATARMNET3ed11fdc8d(DATARMNET543491eb0f->priority);
  if (DATARMNETaa568481cf) {
...
int DATARMNET37a9efbbcb(struct sk_buff *DATARMNETaafc1d9519,
  ...
  if (!DATARMNET54338da2ff) {
    DATARMNET112d724eff(
        "\x41\x50\x53\x5f\x47\x4e\x4c\x3a\x20\x65\x72\x72\x6f\x72\x20\x2d\x20"
        "\x69\x6e\x66\x6f\x20\x69\x73\x20\x6e\x75\x6c\x6c"
        "\n");
    return -EINVAL;
  }
  ...
  if (DATARMNET9c5e00ef03) {
    if (nla_memcpy(&DATARMNETddcafd8b91, DATARMNET9c5e00ef03,
      ...
      DATARMNET112d724eff(
          "\x41\x50\x53\x5f\x47\x4e\x4c\x3a\x20\x6e\x6c\x61\x5f\x6d\x65\x6d\x63"
          "\x70\x79\x20\x66\x61\x69\x6c\x65\x64\x20\x25\x64"
          "\n",
          DATARMNET98b93f2e86);
      return -EINVAL;
    }
  } else {
    DATARMNET112d724eff("\x41\x50\x53\x5f\x47\x4e\x4c\x3a\x20\x6e\x6f\x20\x69"
                        "\x6e\x66\x6f\x2d\x3e\x61\x74\x74\x72\x73\x20\x25\x64"
                        "\n",
                        DATARMNET98b93f2e86);
    return -EINVAL;
  }
  ...
  case DATARMNET63ff5c35c2:
    ...
    DATARMNET112d724eff(
        "\x61\x70\x73\x20\x63\x6c\x69\x65\x6e\x74\x20\x69\x6e\x69\x74\x20\x63"
        "\x6f\x6f\x6b\x69\x65\x20\x30\x78\x25\x78"
        "\n",
        DATARMNET2fe4661b82);
  ...
  DATARMNETa13fcf9070.DATARMNETbb588401ec =
      DATARMNETddcafd8b91.DATARMNETbb588401ec;
  DATARMNETb14e52a504 = DATARMNET1d51fe00f2(DATARMNET54338da2ff,
                                            &DATARMNETa13fcf9070, GFP_KERNEL);
...
static int __init DATARMNET0718a3fa4c(void) {
  ...
  if (DATARMNETb14e52a504) {
    pr_err("\x61\x70\x73\x3a\x20\x66\x61\x69\x6c\x65\x64\x20\x74\x6f\x20\x72"
           "\x65\x67\x69\x73\x74\x65\x72\x20\x67\x65\x6e\x6c\x20\x66\x61\x6d"
           "\x69\x6c\x79"
           "\n");
    return DATARMNETb14e52a504;
  }
