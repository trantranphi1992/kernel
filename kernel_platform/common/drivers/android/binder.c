...
/* Background-max: disable FREECESS binder reports to avoid freezing/kill policies. */
static bool bg_max_disable_freecess_binder_report = true;
module_param_named(bg_max_disable_freecess_binder_report, bg_max_disable_freecess_binder_report, bool, 0644);
MODULE_PARM_DESC(bg_max_disable_freecess_binder_report, "Disable FREECESS binder reports (background-max)");
...
static void freecess_async_binder_report(struct binder_proc *proc,
						...
						struct binder_transaction *t)
{
	if (bg_max_disable_freecess_binder_report)
		return;
