...
static const int congestion_threshold = 98;	/* percentage of congestion threshold */
static const int max_tgroup_io_ratio = 80;	/* maximum service ratio for each thread group */
static const int max_async_write_ratio = 50;	/* maximum service ratio for async write */
